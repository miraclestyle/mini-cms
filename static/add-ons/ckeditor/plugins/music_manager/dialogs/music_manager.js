CKEDITOR.dialog.add("music_manager", function (c) {
    var e = function (f) {
        var f = new Object();
        f.code = "";
        return f
    ...
    return {
        ...
        onOk: function () {
            ...
            if (k) {
                ...
                l.setHtml(Elvin.musicmanager.ckeditorHandle());
                h.insertElement(l)
            }
        },
        contents: [{
            ...
            elements: [{
                ...
                {
                type: "html",
                html: '<div align="center">'+Elvin.musicmanager.open({'size': 0, 'array' : false, 'ckeditor' : true, 'custom' : ' '})+'</div>' 
             }]
        }]
    }]
}});