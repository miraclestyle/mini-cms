CKEDITOR.dialog.add("photo_manager", function (c) {
    var e = function (f) {
        var f = new Object();
        f.code = "";
        return f
    ...
    return {
        ...
        onOk: function () {
            ...
            if (k) {
                ...
                l.setHtml(Elvin.photomanager.ckeditorHandle());
                h.insertElement(l)
            }
        },
        contents: [{
            ...
            elements: [{
                ...
                {
                type: "html",
                html: '<div align="center">'+Elvin.photomanager.open({'size': 0, 'array' : false, 'ckeditor' : true, 'custom' : ' '})+'</div>' 
             }]
        }]
    }]
}});